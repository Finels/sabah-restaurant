...
public class PrinterUtil {
    ...
    public static final String USER = "504096193@qq.com"; //*必填*：账号名
    public static final String UKEY = "tcv9h6gpvWYZYQJT"; //*必填*: 注册账号后生成的UKEY
...
//			System.out.println(method4);
    ...
    public static String addprinter(String snlist) throws Exception {
    ...
    public static String delPrinter(String snlist) throws Exception {
    ...
    //根据操作结果获取该打印机SN是否成功or失败
    public static Boolean getResultStatus(String result, String sn) {
        JSONObject jsonObject = JSON.parseObject(result);
        JSONArray array = jsonObject.getJSONArray("ok");
        if (array != null) {
            for (String snStr : array.toJavaList(String.class)) {
                if (snStr.contains(sn)) {
                    return true;
                }
            }
        }
